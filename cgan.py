...
D_w1 = tf.Variable(xavier_init([784 + 10, 128]))
...
G_w1 = tf.Variable(xavier_init([100 + 10, 128]))
...
for it in range(10000):
    ...
    _, D_loss_curr = sess.run([D_solver, D_loss], feed_dict={X: X_batch, Z: Z_batch, Y:Y_batch})
    _, G_loss_curr = sess.run([G_solver, G_loss], feed_dict={Z: Z_batch, Y:Y_batch})
